...
(function (w) {
    ...
    h.prototype = {
        ...
        toMatrix: function (a) {
            ...
            e = g * e * d;
            d *= g * d;
            return a ? [[1 - (p + d), l - b, c + h], [l + b, 1 - (k + d), e - f], [c - h, e + f, 1 - (k + p)]] : [1 - (p + d), l - b, c + h, l + b, 1 - (k + d), e - f, c - h, e + f, 1 - (k + p)]
        },
        toMatrix4: function (a) {
            ...
            e = g * e * d;
            d *= g * d;
            return a ? [[1 - (p + d), l - b, c + h, 0], [l + b, 1 - (k + d), e - f, 0], [c - h, e + f, 1 - (k + p), 0], [0, 0,
0, 1]] : [1 - (p + d), l - b, c + h, 0, l + b, 1 - (k + d), e - f, 0, c - h, e + f, 1 - (k + p), 0, 0, 0, 0, 1]
        },
        clone: function () {
            return new h(this)
        },
